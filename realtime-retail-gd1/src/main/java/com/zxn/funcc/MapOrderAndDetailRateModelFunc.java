...
public class MapOrderAndDetailRateModelFunc extends RichMapFunction<JSONObject,JSONObject> {
    ...
    private final List<com.zxn.dim.DimBaseCategory> dimBaseCategories;
    ...
    public MapOrderAndDetailRateModelFunc(List<com.zxn.dim.DimBaseCategory> dimBaseCategories, double timeRate, double amountRate, double brandRate, double categoryRate) {
