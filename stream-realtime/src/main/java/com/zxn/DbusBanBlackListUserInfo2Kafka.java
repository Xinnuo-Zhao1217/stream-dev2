...
import com.zxn.func.FilterBloomDeduplicatorFunc;
import com.zxn.func.MapCheckRedisSensitiveWordsFunc;
import com.zxn.func.SensitiveWordHelper;
 ...
 * @Author zhao.xinnuo
 * @Date 2025/5/7 10:53
 * @description: DbusBanBlackListUserInfo2Kafka
 */
public class DbusBanBlackListUserInfo2Kafka {

    private static final String kafka_botstrap_servers = "cdh03";
