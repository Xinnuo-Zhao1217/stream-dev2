...
import com.zxn.func.AsyncHbaseDimBaseDicFunc;
import com.zxn.func.IntervalJoinOrderCommentAndOrderInfoFunc;
import com.zxn.util.*;
...
/**
 * @Package com.zxn.DbusDBCommentFactData2Kafka
 * @Author zhao.xinnuo
 * @Date 2025/5/7 11:19
 * @description: DbusDBCommentFactData2Kafka
 */
public class DbusDBCommentFactData2Kafka {
    ...
    public static void main(String[] args) {
        ...
        SingleOutputStreamOperator<String> kafkaCdcDbSource = env.fromSource(
                ...
                "kafka_cdc_zxn_source"
        ).uid("kafka_cdc_zxn_source").name("kafka_cdc_zxn_source");
        ...
        DataStream<JSONObject> filteredOrderInfoStream = kafkaCdcDbSource
                ...
                .uid("kafka_cdc_zxn_order_source").name("kafka_cdc_zxn_order_source");
